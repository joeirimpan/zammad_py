...
Zammad API Client could always use more documentation, whether as part of the
...
1. Fork the `zammad_py` repo on GitHub.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/joeirimpan/zammad_py/pull_requests

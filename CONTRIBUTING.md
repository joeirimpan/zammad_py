...
```bash
pip3 install poetry flake8 sphinx
```
...
4. This project uses Poetry (https://python-poetry.org/). Set up the project's dependencies like this:
...
```bash
source ~/.cache/pypoetry/virtualenvs/zammad-py*/bin/activate
```
